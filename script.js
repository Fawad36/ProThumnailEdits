...
// // Preview Dragging and Resizing (Desktop Only)
...
//   previewContainer.addEventListener('resize', () => {
//     const rect = previewContainer.getBoundingClientRect();
...
//     newWidth = Math.max(160, Math.min(newWidth, 640));
//     newHeight = Math.max(90, Math.min(newHeight, 360));
...
//     previewCanvas.width = previewContainer.offsetWidth;
//     previewCanvas.height = previewContainer.offsetWidth / (16 / 9);
//   }
...
//   // Placeholder for layer reordering logic if needed
//   drawImage();
//   saveState();
// }
...
//   // Draw the additional image with rotation and opacity
...
canvas.addEventListener('mousedown', (e) => {
  ...
  texts.forEach((text, index) => {
    ...
    if (
      ...
      activeTextIndex = index // ethnic://www.youtube.com/watch?v=4U27sK5I5jM&t=120s
      dragging = true;
    }
  });
